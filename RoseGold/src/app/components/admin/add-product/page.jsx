...
export default function AddProduct() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            weight: Yup.string()
                .oneOf(['large', 'medium', 'small', ''], 'Weight must be large, medium, or small')
                .notRequired(),
            category: Yup.string()
        ...
        onSubmit: async (values, { setSubmitting, setFieldError }) => {
            try {
                ...
                formData.append('img', selectedFile); // field name must match multer
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                    ...
                    <Box sx={{ flexDirection: 'column', width: "100%" }}>
                        <StyledForm onSubmit={formik.handleSubmit}>
                            ...
                            >
                                <option value="">Select weight (optional)</option>
                                <option value="large">بزرگ</option>
                                <option value="medium">معمولی</option>
                                <option value="small">کوچک</option>
                            </select>
                            {formik.touched.weight && Boolean(formik.errors.weight) && (
                                <Typography variant="body2" color="error">{formik.errors.weight}</Typography>
                            )}

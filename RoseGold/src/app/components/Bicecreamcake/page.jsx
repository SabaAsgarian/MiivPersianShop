    ...
    <div>
      ...
      <Box sx={{ direction: "rtl", width: '90%' }}>
          ...
          <Typography sx={{ fontFamily: "mineB", fontSize: "16px" }}>
            کیک‌بستنی‌های میو، جشن طعم در هر برش:
      ...
      ترکیبی از بستنی‌های تازه و خوش‌طعم میو
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             همراه با میوه‌های فصل و سس‌های دست‌ساز
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             گاناش شکلاتی، کرانچ‌های خوشمزه و مرنگ
            </Typography>
          </CustomListItem>
          <CustomListItem>
         ...
         زی
          <CustomListItem>
            ...
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             در دو سایز متوسط (4 تا 6 نفر) و بزرگ (12 تا 15 نفر)
            </Typography>
          </CustomListItem>

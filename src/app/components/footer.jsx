...
export default function footer() {
    return (
        <>
            <Box sx={{ width: '100%', height: 'auto', display: 'flex', justifyContent: 'start', alignItems: 'start', backgroundColor: 'white', marginTop: '2%', color: 'black' }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'start', width: '100%',   }}> {/* Changed to column */}
                    ...
                    >
                        <Item><a href="#link1" style={{ color: 'black', textDecoration: 'none', textAlign: 'center' }}>
                            <h1 style={{fontFamily:"mine",fontSize:"18px",}} className="green">حریم خصوصی</h1>
                        ...
                        <Item><a href="#link1" style={{ color: 'black', textDecoration: 'none', textAlign: 'center' }}>
                            <h1 style={{fontFamily:"mine",fontSize:"18px"}} className="green">درباره بستنی میو</h1>

                    


                        </a></Item>
                        <Item><a href="../components/contact" style={{ color: 'black', textDecoration: 'none', textAlign: 'center' }}>
                            <h1 style={{fontFamily:"mine",fontSize:"18px"}} className="green">تماس با ما</h1>
                        ...
                        <Item><a href="#link1" style={{ color: 'black', textDecoration: 'none', textAlign: 'center' }}>
                            <h1 style={{fontFamily:"mine",fontSize:"18px"}} className="green">بلاگ</h1>
                            ...
                            <Item sx={{backgroundColor:"white"}}>
                              ...
                              <Link href='https://www.instagram.com/saba_asgarian_web?igsh=M2Z2dTU3cHFmeW1o&utm_source=qr'>
                                ...
                                <Link href='https://www.linkedin.com/in/saba-asgarian-69161088?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app'>
                                    <LinkedInIcon sx={{ color: 'black', ml: '2%' }} className="green"/> {/* Set color here */}
                                </Link>
                                <Link href='https://github.com/SabaAsgarian'>
                                    <GitHubIcon sx={{ color: 'black', ml: '2%' }} className="green"/> {/* Set color here */}
                                </Link>
                                <Link href='mailto:computer.sabaa@gmail.com'>
                                    <MailIcon sx={{ color: 'black', ml: '2%' }} className="green"/> {/* Set color here */}
                                </Link>
                              </Box>
                            </Item>
                        </Stack>

...
async function getData() {
  const res = await fetch('https://miivpersianshop.onrender.com/api/category/icecream', {
  ...
  return (
    <div>
      ...
      <Box sx={{ direction: "rtl", width: '90%' }}>
        <Typography sx={{ fontFamily: "mineB", fontSize: "16px" }}>بستنی رژیمی میو خوش‌طعم، بدون شکر، کاملاً سالم</Typography>

        <Typography sx={{ fontFamily: "mine", fontSize: "16px", marginTop: "2%", marginBottom: "2%" }}>
          شیرین‌شده با میوه ی خرمای و استویا، بدون قند افزوده و مواد مصنوعی. مناسب برای رژیم‌های سالم و کنترل قند خون
        </Typography>

        <Typography sx={{ fontFamily: "mineB", fontSize: "16px" }}>سه نوع داریم:</Typography>
        <List>
          <CustomListItem>
            ...
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
              پایه لبنی، کم‌کربوهیدرات، بدون شکر (با طعم های: وانیل و شکلات)
            </Typography>
          </CustomListItem>
          <CustomListItem>
            <Typography variant="body1" sx={{marginRight: 1, fontFamily: "mineB", fontSize: "16px" }}>
        ...
        <List>
          <CustomListItemtwo>
            <Typography variant="body1" sx={{ fontFamily: "mineB", fontSize: "16px" }}>
              های مینرال | high mineral :
            </Typography>
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
              درست شده از کنجد سیاه که سرشار از مواد معدنی ضروری است.
            </Typography>
          </CustomListItemtwo>
          <CustomListItemtwo>
            <Typography variant="body1" sx={{ fontFamily: "mineB", fontSize: "16px" }}>
              های پروتئین | high protein :
            </Typography>
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
              تهیه شده از نخود و پروتئین وی با کیفیت بالا
            </Typography>
          </CustomListItemtwo>

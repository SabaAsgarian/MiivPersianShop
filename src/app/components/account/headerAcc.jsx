      ...
      <>
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', width: '20%' }}>
            ...
            <Typography variant="h6" sx={{ marginLeft: 1,fontFamily:"mine",color:"white",backgroundColor:"#45424e",borderRadius:"10px",paddingLeft:"10px",paddingRight:"10px" }}>۰۲۱۲۶۴۵۰۸۹۲</Typography>
        ...
        <AppBar position="static">
          <Toolbar>
            <Box sx={{
              ...
              <StyledLink href="../ASorbet">سربه لیوانی</StyledLink>
              <StyledLink href="../Bicecreamcake">کیک بستنی</StyledLink>
              <StyledLink href="../Cfrozenyogurt">ماست بستنی لیوانی</StyledLink>
              <StyledLink href="../Dicecream">بستنی رژیمی</StyledLink>
        ...
        >
          ...
          <List>
            <ListItem disablePadding>
              <StyledListItemButton component="a" href="../ASorbet" sx={{ justifyContent: 'center' }}>
                <Typography sx={{ fontFamily: "mineB", textAlign: "center",marginTop:"10%" }}>سربه لیوانی</Typography>
              </StyledListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <StyledListItemButton component="a" href="../Bicecreamcake" sx={{ justifyContent: 'center' }}>
                <Typography sx={{ fontFamily: "mineB", textAlign: "center",marginTop:"10%" }}>کیک بستنی</Typography>
              </StyledListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <StyledListItemButton component="a" href="../Cfrozenyogurt" sx={{ justifyContent: 'center' }}>
                <Typography sx={{ fontFamily: "mineB", textAlign: "center",marginTop:"10%" }}>ماست بستنی لیوانی</Typography>
              </StyledListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <StyledListItemButton component="a" href="../Dicecream" sx={{ justifyContent: 'center' }}>
                <Typography sx={{ fontFamily: "mineB", textAlign: "center" ,marginTop:"10%"}}>بستنی رژیمی</Typography>
              </StyledListItemButton>
            </ListItem>
            <ListItem disablePadding>
              <StyledListItemButton component="a" href="../contact" sx={{ justifyContent: 'center' }}>

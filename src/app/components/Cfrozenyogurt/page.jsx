...
async function getData() {
  const res = await fetch('https://miivpersianshop.onrender.com/api/category/frozenyogurt', {
    ...
    <div>
     ...
     ماست بستنی لیوانی
      ...
      <Box sx={{ direction: "rtl", width: '90%' }}>
          ...
          ماست‌بستنی‌های میو، خنک، سالم و خوش‌طعم:
      ...
      تهیه‌شده از ماست پروبیوتیک و کم‌چرب
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             گزینه‌ای سالم‌تر و سبک‌تر از بستنی‌های کلاسیک
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             حاوی باکتری‌های مفید برای کمک به عملکرد گوارش
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
            بافتی لطیف، طعمی ملایم و خنک
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
             تهیه شده با شیرکم چرب، بدون خامه (مناسب برای رژیم غذایی متعادل)
            </Typography>
          </CustomListItem>
          <CustomListItem>
            
            <Typography variant="body2" sx={{ marginRight: 1, fontFamily: "mine", fontSize: "16px" }}>
            انتخاب عالی برای کسانی که تغذیه سالم براشون مهمه
            </Typography>
          </CustomListItem>

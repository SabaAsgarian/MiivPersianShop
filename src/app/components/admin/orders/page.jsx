...
export default function Orders() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const response = await fetch("https://miivpersianshop.onrender.com/api/orders/all", {
        method: "GET",
        headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://miivpersianshop.onrender.com/api/orders/${id}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
